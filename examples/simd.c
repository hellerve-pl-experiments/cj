...
int main(void) {
  ...
  // Memory operands
  cj_operand dst_mem = {.type = CJ_MEMORY, .mem = {.base = "x0", .index = NULL, .scale = 1, .disp = 0}};
  cj_operand src_a_mem = {.type = CJ_MEMORY, .mem = {.base = "x1", .index = NULL, .scale = 1, .disp = 0}};
  cj_operand src_b_mem = {.type = CJ_MEMORY, .mem = {.base = "x2", .index = NULL, .scale = 1, .disp = 0}};
