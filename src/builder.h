...
static inline void cj_builder_fn_prologue(cj_ctx* ctx, size_t requested_stack_bytes, cj_builder_frame* frame);
...
static inline void cj_builder_loop_condition(cj_ctx* ctx, cj_builder_block block, cj_operand lhs, cj_operand rhs, cj_condition exit_cond);
...
static inline cj_builder_if_block cj_builder_if(cj_ctx* ctx, cj_operand lhs, cj_operand rhs, cj_condition cond);
...
static inline cj_builder_for_loop cj_builder_for_begin(cj_ctx* ctx, cj_operand counter, cj_operand start, cj_operand limit, cj_operand step, cj_condition exit_cond);
...
static inline void cj_builder_return_value(cj_ctx* ctx, const cj_builder_frame* frame, cj_operand value);
...
static inline void cj_builder_fn_prologue(cj_ctx* ctx, size_t requested_stack_bytes, cj_builder_frame* frame) {
  ...
  if (frame) frame->stack_size = aligned;
...
static inline cj_condition invert_condition(cj_condition cond) {
  switch (cond) {
    case CJ_COND_O:  return CJ_COND_NO;
    case CJ_COND_NO: return CJ_COND_O;
    case CJ_COND_B:  return CJ_COND_NB;
    case CJ_COND_NB: return CJ_COND_B;
    case CJ_COND_Z:  return CJ_COND_NZ;
    case CJ_COND_NZ: return CJ_COND_Z;
    case CJ_COND_BE: return CJ_COND_A;
    case CJ_COND_A:  return CJ_COND_BE;
    case CJ_COND_S:  return CJ_COND_NS;
    case CJ_COND_NS: return CJ_COND_S;
    case CJ_COND_P:  return CJ_COND_NP;
    case CJ_COND_NP: return CJ_COND_P;
    case CJ_COND_L:  return CJ_COND_GE;
    case CJ_COND_GE: return CJ_COND_L;
    case CJ_COND_LE: return CJ_COND_G;
    case CJ_COND_G:  return CJ_COND_LE;
    default:         return CJ_COND_NE;
  }
}
...
#if defined(__x86_64__) || defined(_M_X64)
  switch (cond) {
    case CJ_COND_O: cj_jo(ctx, target); break;
    case CJ_COND_NO: cj_jno(ctx, target); break;
    case CJ_COND_B: cj_jb(ctx, target); break;
    case CJ_COND_NB: cj_jnb(ctx, target); break;
    case CJ_COND_Z: cj_jz(ctx, target); break;
    case CJ_COND_NZ: cj_jnz(ctx, target); break;
    case CJ_COND_BE: cj_jbe(ctx, target); break;
    case CJ_COND_A: cj_ja(ctx, target); break;
    case CJ_COND_S: cj_js(ctx, target); break;
    case CJ_COND_NS: cj_jns(ctx, target); break;
    case CJ_COND_P: cj_jp(ctx, target); break;
    case CJ_COND_NP: cj_jnp(ctx, target); break;
    case CJ_COND_L: cj_jl(ctx, target); break;
    case CJ_COND_GE: cj_jge(ctx, target); break;
    case CJ_COND_LE: cj_jle(ctx, target); break;
    case CJ_COND_G: cj_jg(ctx, target); break;
    default: assert(0 && "unsupported condition");
  }
#elif defined(__aarch64__) || defined(_M_ARM64)
  switch (cond) {
    case CJ_COND_O: cj_bvs(ctx, target); break;
    case CJ_COND_NO: cj_bvc(ctx, target); break;
    case CJ_COND_B: cj_bcc(ctx, target); break;
    case CJ_COND_NB: cj_bcs(ctx, target); break;
    case CJ_COND_Z: cj_beq(ctx, target); break;
    case CJ_COND_NZ: cj_bne(ctx, target); break;
    case CJ_COND_BE: cj_bls(ctx, target); break;
    case CJ_COND_A: cj_bhi(ctx, target); break;
    case CJ_COND_S: cj_bmi(ctx, target); break;
    case CJ_COND_NS: cj_bpl(ctx, target); break;
    case CJ_COND_L: cj_blt(ctx, target); break;
    case CJ_COND_GE: cj_bge(ctx, target); break;
    case CJ_COND_LE: cj_ble(ctx, target); break;
