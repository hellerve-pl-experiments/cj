...
static cj_condition invert_condition(cj_condition cond) {
  switch (cond) {
...
static void branch_on_condition(cj_ctx* ctx, cj_condition cond, cj_label target) {
#if defined(__x86_64__) || defined(_M_X64)
  switch (cond) {
...
static void branch_unconditional(cj_ctx* ctx, cj_label target) {
#if defined(__x86_64__) || defined(_M_X64)
  cj_jmp(ctx, target);
#elif defined(__aarch64__) || defined(_M_ARM64)
  cj_b(ctx, target);
...
static cj_operand get_return_operand(void) {
#if defined(__x86_64__) || defined(_M_X64)
